...
class VariableDef : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.VariableDef) */ {
 ...
 private:
  ...
  friend void  protobuf_InitDefaults_variable_2eproto_impl();
  friend void  protobuf_AddDesc_variable_2eproto_impl();
  friend void protobuf_AssignDesc_variable_2eproto();
  friend void protobuf_ShutdownFile_variable_2eproto();
