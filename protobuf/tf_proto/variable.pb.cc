...
void protobuf_AssignDesc_variable_2eproto() GOOGLE_ATTRIBUTE_COLD;
void protobuf_AssignDesc_variable_2eproto() {
  protobuf_AddDesc_variable_2eproto();
...
void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_variable_2eproto);
}
...
void protobuf_ShutdownFile_variable_2eproto() {
...
void protobuf_InitDefaults_variable_2eproto_impl() {
...
GOOGLE_PROTOBUF_DECLARE_ONCE(protobuf_InitDefaults_variable_2eproto_once_);
void protobuf_InitDefaults_variable_2eproto() {
  ::google::protobuf::GoogleOnceInit(&protobuf_InitDefaults_variable_2eproto_once_,
                 &protobuf_InitDefaults_variable_2eproto_impl);
}
void protobuf_AddDesc_variable_2eproto_impl() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  protobuf_InitDefaults_variable_2eproto();
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "ProtosP\001\370\001\001b\006proto3", 379);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "variable.proto", &protobuf_RegisterTypes);
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_variable_2eproto);
}

GOOGLE_PROTOBUF_DECLARE_ONCE(protobuf_AddDesc_variable_2eproto_once_);
void protobuf_AddDesc_variable_2eproto() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AddDesc_variable_2eproto_once_,
                 &protobuf_AddDesc_variable_2eproto_impl);
}
// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_variable_2eproto {
  StaticDescriptorInitializer_variable_2eproto() {
    protobuf_AddDesc_variable_2eproto();
  }
} static_descriptor_initializer_variable_2eproto_;
...
VariableDef::VariableDef()
  ...
  if (this != internal_default_instance()) protobuf_InitDefaults_variable_2eproto();
  SharedCtor();
